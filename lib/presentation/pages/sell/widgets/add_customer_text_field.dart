...
class AddCustomerTextField extends StatefulWidget {
  final String hintText;
  final IconData icon;
  final  double width;
  final bool enabled;

  const AddCustomerTextField({super.key, required this.hintText,required this.icon, required this.width, required this.enabled});

  @override
  State<AddCustomerTextField> createState() => _AddCustomerTextFieldState();
}

class _AddCustomerTextFieldState extends State<AddCustomerTextField> {
  @override
